...
class FileApi
{
     ...
     *
     * @param  \BytescalePHP\Client\Model\CopyFileRequest $body body (required)
     ...
     * @return \BytescalePHP\Client\Model\CopyFileResponse
     */
     ...
     * Copies a file synchronously.
     *
     * @param  \BytescalePHP\Client\Model\CopyFileRequest $body (required)
     * @param  \BytescalePHP\Client\Model\AccountId $account_id (required)
     *
     * @throws \BytescalePHP\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BytescalePHP\Client\Model\CopyFileResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function copyFileWithHttpInfo($body, $account_id)
    {
        $returnType = '\BytescalePHP\Client\Model\CopyFileResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BytescalePHP\Client\Model\CopyFileResponse',
     ...
     *
     * @param  \BytescalePHP\Client\Model\CopyFileBatchRequest $body body (required)
     * @param  \BytescalePHP\Client\Model\AccountId $account_id account_id (required)
     *
     * @throws \BytescalePHP\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Copies multiple files asynchronously.
     *
     * @param  \BytescalePHP\Client\Model\CopyFileBatchRequest $body (required)
     * @param  \BytescalePHP\Client\Model\AccountId $account_id (required)
     *
     * @throws \BytescalePHP\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \BytescalePHP\Client\Model\AccountId $account_id account_id (required)
     * @param  \BytescalePHP\Client\Model\FilePath $file_path file_path (required)
     *
     * @throws \BytescalePHP\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  \BytescalePHP\Client\Model\AccountId $account_id (required)
     * @param  \BytescalePHP\Client\Model\FilePath $file_path (required)
     *
     * @throws \BytescalePHP\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \BytescalePHP\Client\Model\DeleteFileBatchRequest $body body (required)
     * @param  \BytescalePHP\Client\Model\AccountId $account_id account_id (required)
     *
     * @throws \BytescalePHP\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Deletes multiple files asynchronously.  Requires a `secret_*` API key. Alternatively, you can use a `public_*` API key and JWT-based auth.
     *
     * @param  \BytescalePHP\Client\Model\DeleteFileBatchRequest $body (required)
     * @param  \BytescalePHP\Client\Model\AccountId $account_id (required)
     *
     * @throws \BytescalePHP\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    protected function downloadFileRequest($account_id, $file_path, $cache = null, $cache_ttl = null, $version = null)
    {
        ...
        // query params
        if ($cache !== null) {
            $queryParams['cache'] = $cache ? "true" : "false";
        }
        // query params
        if ($cache_ttl !== null) {
     ...
     * @throws \BytescalePHP\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BytescalePHP\Client\Model\FileDetails
     */
     ...
     * @throws \BytescalePHP\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BytescalePHP\Client\Model\FileDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFileDetailsWithHttpInfo($account_id, $file_path)
    {
        $returnType = '\BytescalePHP\Client\Model\FileDetails';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BytescalePHP\Client\Model\FileDetails',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \BytescalePHP\Client\Model\AccountId $account_id account_id (required)
     * @param  \BytescalePHP\Client\Model\FilePath $file_path file_path (required)
     * @param  \BytescalePHP\Client\Model\TransformationUrlSlug $transformation The name of the File Processing API (e.g. &#x60;image&#x60;, &#x60;video&#x60;, &#x60;audio&#x60;) or transformation preset (created in the Bytescale Dashboard) to use when processing the file. (required)
     * @param  \BytescalePHP\Client\Model\TransformationArtifactPath $artifact Some transformations output multiple files, called artifacts.  You can download each individual transformation artifact by specifying its path with this parameter (optional)
     ...
     *
     * @param  \BytescalePHP\Client\Model\ProcessFileAndSaveRequest $body File output parameters. (required)
     * @param  \BytescalePHP\Client\Model\AccountId $account_id account_id (required)
     * @param  \BytescalePHP\Client\Model\FilePath $file_path file_path (required)
     * @param  \BytescalePHP\Client\Model\TransformationUrlSlug $transformation The name of the File Processing API (e.g. &#x60;image&#x60;, &#x60;video&#x60;, &#x60;audio&#x60;) or transformation preset (created in the Bytescale Dashboard) to use when processing the file. (required)
     * @param  \BytescalePHP\Client\Model\TransformationParams $transformation_params Parameters to submit to the File Processing API (e.g. the Image Processing API).  Please see the documentation for each File Processing API to determine which values can appear here:  - https://www.bytescale.com/docs/image-processing-api - https://www.bytescale.com/docs/video-processing-api - https://www.bytescale.com/docs/audio-processing-api - https://www.bytescale.com/docs/archive-processing-api (optional)
     ...
     * @throws \BytescalePHP\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BytescalePHP\Client\Model\ProcessFileAndSaveResponse
     */
     ...
     * @throws \BytescalePHP\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BytescalePHP\Client\Model\ProcessFileAndSaveResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function processFileAndSaveWithHttpInfo($body, $account_id, $file_path, $transformation, $transformation_params = null)
    {
        $returnType = '\BytescalePHP\Client\Model\ProcessFileAndSaveResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BytescalePHP\Client\Model\ProcessFileAndSaveResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
