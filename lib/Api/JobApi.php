...
class JobApi
{
     ...
     * @param  \Swagger\Client\Model\AccountJobId $job_id job_id (required)
     * @param  \Swagger\Client\Model\AccountJobType $job_type job_type (required)
     *
     ...
     * @param  \Swagger\Client\Model\AccountJobId $job_id (required)
     * @param  \Swagger\Client\Model\AccountJobType $job_type (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\JobSummary
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\JobSummary, HTTP status code, HTTP response headers (array of strings)
     */
    public function getJobWithHttpInfo($account_id, $job_id, $job_type)
    {
        $returnType = '\Swagger\Client\Model\JobSummary';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\JobSummary',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ListRecentJobsResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ListRecentJobsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listRecentJobsWithHttpInfo($account_id, $job_type)
    {
        $returnType = '\Swagger\Client\Model\ListRecentJobsResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ListRecentJobsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
