...
class FolderApi
{
     ...
     *
     * @param  \Swagger\Client\Model\CopyFolderRequest $body body (required)
     ...
     * Copies a folder asynchronously.  You can use ListFolder to preview the operation using the `dryRun` parameter.
     *
     * @param  \Swagger\Client\Model\CopyFolderRequest $body (required)
     ...
     *
     * @param  \Swagger\Client\Model\CopyFolderBatchRequest $body body (required)
     * @param  \Swagger\Client\Model\AccountId $account_id account_id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Copies multiple folders asynchronously.  You can use ListFolder to preview the operation using the `dryRun` parameter.
     *
     * @param  \Swagger\Client\Model\CopyFolderBatchRequest $body (required)
     * @param  \Swagger\Client\Model\AccountId $account_id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Swagger\Client\Model\DeleteFolderRequest $body body (required)
     * @param  \Swagger\Client\Model\AccountId $account_id account_id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Deletes a folder asynchronously.  You can use ListFolder to preview the operation using the `dryRun` parameter.  *When deleting a folder with external storage:* if the folder at `folderPath` has overridden storage settings (like an AWS S3 bucket), no files will be deleted, regardless of the parameters you pass. Only the mapping will be removed. If the folder at `folderPath` has inherited storage settings but includes subfolders with overridden storage settings, files in those subfolders won't be deleted, regardless of the parameters you pass. In summary, files in folders with overridden storage are never deleted, unless you directly delete a subfolder of such a folder.  Requires a `secret_*` API key. Alternatively, you can use a `public_*` API key and JWT-based auth.
     *
     * @param  \Swagger\Client\Model\DeleteFolderRequest $body (required)
     * @param  \Swagger\Client\Model\AccountId $account_id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Swagger\Client\Model\DeleteFolderBatchRequest $body body (required)
     * @param  \Swagger\Client\Model\AccountId $account_id account_id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Deletes multiple folders asynchronously.  You can use ListFolder to preview the operation using the `dryRun` parameter.  *When deleting a folder with external storage:* if the folder at `folderPath` has overridden storage settings (like an AWS S3 bucket), no files will be deleted, regardless of the parameters you pass. Only the mapping will be removed. If the folder at `folderPath` has inherited storage settings but includes subfolders with overridden storage settings, files in those subfolders won't be deleted, regardless of the parameters you pass. In summary, files in folders with overridden storage are never deleted, unless you directly delete a subfolder of such a folder.  Requires a `secret_*` API key. Alternatively, you can use a `public_*` API key and JWT-based auth.
     *
     * @param  \Swagger\Client\Model\DeleteFolderBatchRequest $body (required)
     * @param  \Swagger\Client\Model\AccountId $account_id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Swagger\Client\Model\AccountId $account_id account_id (required)
     * @param  \Swagger\Client\Model\FolderPath $folder_path folder_path (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\FolderDetails
     */
     ...
     *
     * @param  \Swagger\Client\Model\AccountId $account_id (required)
     * @param  \Swagger\Client\Model\FolderPath $folder_path (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\FolderDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFolderDetailsWithHttpInfo($account_id, $folder_path)
    {
        $returnType = '\Swagger\Client\Model\FolderDetails';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\FolderDetails',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \Swagger\Client\Model\AccountId $account_id account_id (required)
     * @param  \Swagger\Client\Model\FolderPath $folder_path folder_path (required)
     * @param  \Swagger\Client\Model\ListFolderCursor $cursor cursor (optional)
     * @param  \Swagger\Client\Model\ListFolderDryRun $dry_run dry_run (optional)
     * @param  \Swagger\Client\Model\IncludeFiles $include_files include_files (optional)
     * @param  \Swagger\Client\Model\IncludeOverriddenStorage $include_overridden_storage include_overridden_storage (optional)
     * @param  \Swagger\Client\Model\IncludePhysicalFolders $include_physical_folders include_physical_folders (optional)
     * @param  \Swagger\Client\Model\IncludeVirtualFolders $include_virtual_folders include_virtual_folders (optional)
     * @param  \Swagger\Client\Model\ListFolderItemLimit $limit limit (optional)
     * @param  \Swagger\Client\Model\IterateFolderRecursively $recursive recursive (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ListFolderResponse
     */
     ...
     * @param  \Swagger\Client\Model\AccountId $account_id (required)
     * @param  \Swagger\Client\Model\FolderPath $folder_path (required)
     * @param  \Swagger\Client\Model\ListFolderCursor $cursor (optional)
     * @param  \Swagger\Client\Model\ListFolderDryRun $dry_run (optional)
     * @param  \Swagger\Client\Model\IncludeFiles $include_files (optional)
     * @param  \Swagger\Client\Model\IncludeOverriddenStorage $include_overridden_storage (optional)
     * @param  \Swagger\Client\Model\IncludePhysicalFolders $include_physical_folders (optional)
     * @param  \Swagger\Client\Model\IncludeVirtualFolders $include_virtual_folders (optional)
     * @param  \Swagger\Client\Model\ListFolderItemLimit $limit (optional)
     * @param  \Swagger\Client\Model\IterateFolderRecursively $recursive (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ListFolderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Swagger\Client\Model\ListFolderResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ListFolderResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Swagger\Client\Model\PutFolderRequest $body body (required)
     * @param  \Swagger\Client\Model\AccountId $account_id account_id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Creates or updates the folder specified by the `folderPath`.  If the folder's ancestors do not exist, they will be created automatically (with empty FolderSettings).  Note: you don't need to create folders before uploading files to them.  Requires a `secret_*` API key. Alternatively, you can use a `public_*` API key and JWT-based auth.
     *
     * @param  \Swagger\Client\Model\PutFolderRequest $body (required)
     * @param  \Swagger\Client\Model\AccountId $account_id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
