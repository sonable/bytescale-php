...
/**
 * PickR2StorageExcludeKeyofR2StorageCredentials Class Doc Comment
 *
 * @category Class
 ...
 */
class PickR2StorageExcludeKeyofR2StorageCredentials implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Pick_R2Storage.Exclude_keyofR2Storage.credentials__';
    ...
    */
    ...
    public function setCloudflareAccountId($cloudflareAccountId)
    {
        ...
        if ((mb_strlen($cloudflareAccountId) > 64)) {
            throw new \InvalidArgumentException('invalid length for $cloudflareAccountId when calling PickR2StorageExcludeKeyofR2StorageCredentials., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($cloudflareAccountId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $cloudflareAccountId when calling PickR2StorageExcludeKeyofR2StorageCredentials., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\S*$/", ObjectSerializer::toString($cloudflareAccountId)))) {
            throw new \InvalidArgumentException("invalid value for \$cloudflareAccountId when calling PickR2StorageExcludeKeyofR2StorageCredentials., must conform to the pattern /^\\S*$/.");
        }
