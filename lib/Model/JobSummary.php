    ...
    */
    ...
    public function setJobId($jobId)
    {
        ...
        if ((mb_strlen($jobId) > 26)) {
            throw new \InvalidArgumentException('invalid length for $jobId when calling JobSummary., must be smaller than or equal to 26.');
        }
        if ((mb_strlen($jobId) < 26)) {
            throw new \InvalidArgumentException('invalid length for $jobId when calling JobSummary., must be bigger than or equal to 26.');
        }
        if ((!preg_match("/^[0-9A-Z]+$/", ObjectSerializer::toString($jobId)))) {
            throw new \InvalidArgumentException("invalid value for \$jobId when calling JobSummary., must conform to the pattern /^[0-9A-Z]+$/.");
        }
    ...
    public function setJobUrl($jobUrl)
    {
        ...
        if ((mb_strlen($jobUrl) > 255)) {
            throw new \InvalidArgumentException('invalid length for $jobUrl when calling JobSummary., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($jobUrl) < 1)) {
            throw new \InvalidArgumentException('invalid length for $jobUrl when calling JobSummary., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^https?:\/\/[-a-zA-Z0-9]+(?:\\.[-a-zA-Z0-9]+)+(\/.*)?$/", ObjectSerializer::toString($jobUrl)))) {
            throw new \InvalidArgumentException("invalid value for \$jobUrl when calling JobSummary., must conform to the pattern /^https?:\/\/[-a-zA-Z0-9]+(?:\\.[-a-zA-Z0-9]+)+(\/.*)?$/.");
        }
    ...
    public function setAccountId($accountId)
    {
        ...
        if ((mb_strlen($accountId) > 7)) {
            throw new \InvalidArgumentException('invalid length for $accountId when calling JobSummary., must be smaller than or equal to 7.');
        }
        if ((mb_strlen($accountId) < 7)) {
            throw new \InvalidArgumentException('invalid length for $accountId when calling JobSummary., must be bigger than or equal to 7.');
        }
        if ((!preg_match("/^[1-9A-HJ-NP-Za-km-z]*$/", ObjectSerializer::toString($accountId)))) {
            throw new \InvalidArgumentException("invalid value for \$accountId when calling JobSummary., must conform to the pattern /^[1-9A-HJ-NP-Za-km-z]*$/.");
        }
    ...
    public function setCreated($created)
    {
        ...
        if (($created < 0)) {
            throw new \InvalidArgumentException('invalid value for $created when calling JobSummary., must be bigger than or equal to 0.');
        }
    ...
    public function setLastUpdated($lastUpdated)
    {
        ...
        if (($lastUpdated < 0)) {
            throw new \InvalidArgumentException('invalid value for $lastUpdated when calling JobSummary., must be bigger than or equal to 0.');
        }
