<?php
/**
 * WithFolderPathPublicPermissionsArray
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * WithFolderPathPublicPermissionsArray Class Doc Comment
 *
 * @category Class
 * @package  Bytescale
 * @author   OpenAPI Generator team
 ...
 */
class WithFolderPathPublicPermissionsArray implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WithFolderPath_PublicPermissions-Array_';
    ...
    protected static $openAPITypes = [
        'folderPath' => 'string',
        'value' => '\Bytescale\Model\PublicPermissions[]'
    ];
    ...
    */
    ...
    public function setFolderPath($folderPath)
    {
        ...
        if ((mb_strlen($folderPath) > 512)) {
            throw new \InvalidArgumentException('invalid length for $folderPath when calling WithFolderPathPublicPermissionsArray., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($folderPath) < 1)) {
            throw new \InvalidArgumentException('invalid length for $folderPath when calling WithFolderPathPublicPermissionsArray., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\/.*$/", ObjectSerializer::toString($folderPath)))) {
            throw new \InvalidArgumentException("invalid value for \$folderPath when calling WithFolderPathPublicPermissionsArray., must conform to the pattern /^\/.*$/.");
        }
     ...
     * Gets value
     *
     * @return \Bytescale\Model\PublicPermissions[]
     */
     ...
     * Sets value
     *
     * @param \Bytescale\Model\PublicPermissions[] $value value
     *
     * @return self
     */
