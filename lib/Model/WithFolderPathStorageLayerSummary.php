<?php
/**
 * WithFolderPathStorageLayerSummary
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * WithFolderPathStorageLayerSummary Class Doc Comment
 *
 * @category Class
 * @package  Bytescale
 * @author   OpenAPI Generator team
 ...
 */
class WithFolderPathStorageLayerSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WithFolderPath_StorageLayerSummary_';
    ...
    protected static $openAPITypes = [
        'folderPath' => 'string',
        'value' => '\Bytescale\Model\StorageLayerSummary'
    ];
    ...
    */
    ...
    public function setFolderPath($folderPath)
    {
        ...
        if ((mb_strlen($folderPath) > 512)) {
            throw new \InvalidArgumentException('invalid length for $folderPath when calling WithFolderPathStorageLayerSummary., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($folderPath) < 1)) {
            throw new \InvalidArgumentException('invalid length for $folderPath when calling WithFolderPathStorageLayerSummary., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\/.*$/", ObjectSerializer::toString($folderPath)))) {
            throw new \InvalidArgumentException("invalid value for \$folderPath when calling WithFolderPathStorageLayerSummary., must conform to the pattern /^\/.*$/.");
        }
     ...
     * Gets value
     *
     * @return \Bytescale\Model\StorageLayerSummary
     */
     ...
     * Sets value
     *
     * @param \Bytescale\Model\StorageLayerSummary $value value
     *
     * @return self
     */
