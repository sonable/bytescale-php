 ...
 */
class FolderDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FolderDetails';
    ...
    protected static $openAPITypes = [
        ...
        'type' => 'string',
        'virtual' => 'bool',
        'settingsInherited' => '\Bytescale\Model\FolderSettingsInherited'
    ];
    ...
    protected static $setters = [
        ...
        'type' => 'setType',
        'virtual' => 'setVirtual',
        'settingsInherited' => 'setSettingsInherited'
    ];
    ...
    protected static $getters = [
        ...
        'type' => 'getType',
        'virtual' => 'getVirtual',
        'settingsInherited' => 'getSettingsInherited'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('settingsInherited', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['settingsInherited'] === null) {
            $invalidProperties[] = "'settingsInherited' can't be null";
        }
    ...
    public function setFolderPath($folderPath)
    {
        ...
        if ((mb_strlen($folderPath) > 512)) {
            throw new \InvalidArgumentException('invalid length for $folderPath when calling FolderDetails., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($folderPath) < 1)) {
            throw new \InvalidArgumentException('invalid length for $folderPath when calling FolderDetails., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\/.*$/", ObjectSerializer::toString($folderPath)))) {
            throw new \InvalidArgumentException("invalid value for \$folderPath when calling FolderDetails., must conform to the pattern /^\/.*$/.");
        }
    ...
    /**
     * Gets settingsInherited
     *
     * @return \Bytescale\Model\FolderSettingsInherited
     */
    public function getSettingsInherited()
    {
        return $this->container['settingsInherited'];
    }

    /**
     * Sets settingsInherited
     *
     * @param \Bytescale\Model\FolderSettingsInherited $settingsInherited settingsInherited
     *
     * @return self
     */
    public function setSettingsInherited($settingsInherited)
    {
        if (is_null($settingsInherited)) {
            throw new \InvalidArgumentException('non-nullable settingsInherited cannot be null');
        }
        $this->container['settingsInherited'] = $settingsInherited;
