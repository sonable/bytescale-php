 ...
 */
class ProcessFileAndSaveResponseSync implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProcessFileAndSaveResponseSync';
    ...
    */
    ...
    public function setAccountId($accountId)
    {
        ...
        if ((mb_strlen($accountId) > 7)) {
            throw new \InvalidArgumentException('invalid length for $accountId when calling ProcessFileAndSaveResponseSync., must be smaller than or equal to 7.');
        }
        if ((mb_strlen($accountId) < 7)) {
            throw new \InvalidArgumentException('invalid length for $accountId when calling ProcessFileAndSaveResponseSync., must be bigger than or equal to 7.');
        }
        if ((!preg_match("/^[1-9A-HJ-NP-Za-km-z]*$/", ObjectSerializer::toString($accountId)))) {
            throw new \InvalidArgumentException("invalid value for \$accountId when calling ProcessFileAndSaveResponseSync., must conform to the pattern /^[1-9A-HJ-NP-Za-km-z]*$/.");
        }
    ...
    public function setFilePath($filePath)
    {
        ...
        if ((mb_strlen($filePath) > 512)) {
            throw new \InvalidArgumentException('invalid length for $filePath when calling ProcessFileAndSaveResponseSync., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($filePath) < 1)) {
            throw new \InvalidArgumentException('invalid length for $filePath when calling ProcessFileAndSaveResponseSync., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\/.*$/", ObjectSerializer::toString($filePath)))) {
            throw new \InvalidArgumentException("invalid value for \$filePath when calling ProcessFileAndSaveResponseSync., must conform to the pattern /^\/.*$/.");
        }
    ...
    public function setFileUrl($fileUrl)
    {
        ...
        if ((mb_strlen($fileUrl) > 255)) {
            throw new \InvalidArgumentException('invalid length for $fileUrl when calling ProcessFileAndSaveResponseSync., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($fileUrl) < 1)) {
            throw new \InvalidArgumentException('invalid length for $fileUrl when calling ProcessFileAndSaveResponseSync., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^https?:\/\/[-a-zA-Z0-9]+(?:\\.[-a-zA-Z0-9]+)+(\/.*)?$/", ObjectSerializer::toString($fileUrl)))) {
            throw new \InvalidArgumentException("invalid value for \$fileUrl when calling ProcessFileAndSaveResponseSync., must conform to the pattern /^https?:\/\/[-a-zA-Z0-9]+(?:\\.[-a-zA-Z0-9]+)+(\/.*)?$/.");
        }
     ...
     * Sets summary
     *
     * @param array<string,mixed>|null $summary JSON response returned by certain File Processing APIs.  Structure varies between File Processing APIs (please see the documentation of each individual File Processing API).
     *
     * @return self
     */
