 ...
 */
class CopyFileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CopyFileRequest';
    ...
    */
     ...
     * Sets destination
     *
     * @param string $destination Absolute path to a file. Begins with a `/`.
     *
     * @return self
     */
    public function setDestination($destination)
    {
        ...
        if ((mb_strlen($destination) > 512)) {
            throw new \InvalidArgumentException('invalid length for $destination when calling CopyFileRequest., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($destination) < 1)) {
            throw new \InvalidArgumentException('invalid length for $destination when calling CopyFileRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\/.*$/", ObjectSerializer::toString($destination)))) {
            throw new \InvalidArgumentException("invalid value for \$destination when calling CopyFileRequest., must conform to the pattern /^\/.*$/.");
        }
     ...
     * Sets source
     *
     * @param string $source Absolute path to a file. Begins with a `/`.
     *
     * @return self
     */
    public function setSource($source)
    {
        ...
        if ((mb_strlen($source) > 512)) {
            throw new \InvalidArgumentException('invalid length for $source when calling CopyFileRequest., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($source) < 1)) {
            throw new \InvalidArgumentException('invalid length for $source when calling CopyFileRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\/.*$/", ObjectSerializer::toString($source)))) {
            throw new \InvalidArgumentException("invalid value for \$source when calling CopyFileRequest., must conform to the pattern /^\/.*$/.");
        }
