...
/**
 * FilePathDefinition Class Doc Comment
 *
 * @category Class
 ...
 */
class FilePathDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FilePathDefinition';
    ...
    */
    ...
    public function setFileName($fileName)
    {
        ...
        if ((mb_strlen($fileName) > 512)) {
            throw new \InvalidArgumentException('invalid length for $fileName when calling FilePathDefinition., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($fileName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $fileName when calling FilePathDefinition., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^[^\/]*$/", ObjectSerializer::toString($fileName)))) {
            throw new \InvalidArgumentException("invalid value for \$fileName when calling FilePathDefinition., must conform to the pattern /^[^\/]*$/.");
        }
    ...
    public function setFileNameFallback($fileNameFallback)
    {
        ...
        if ((mb_strlen($fileNameFallback) > 512)) {
            throw new \InvalidArgumentException('invalid length for $fileNameFallback when calling FilePathDefinition., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($fileNameFallback) < 0)) {
            throw new \InvalidArgumentException('invalid length for $fileNameFallback when calling FilePathDefinition., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^[^\/]*$/", ObjectSerializer::toString($fileNameFallback)))) {
            throw new \InvalidArgumentException("invalid value for \$fileNameFallback when calling FilePathDefinition., must conform to the pattern /^[^\/]*$/.");
        }
    ...
    public function setFolderPath($folderPath)
    {
        ...
        if ((mb_strlen($folderPath) > 512)) {
            throw new \InvalidArgumentException('invalid length for $folderPath when calling FilePathDefinition., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($folderPath) < 0)) {
            throw new \InvalidArgumentException('invalid length for $folderPath when calling FilePathDefinition., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^.*$/", ObjectSerializer::toString($folderPath)))) {
            throw new \InvalidArgumentException("invalid value for \$folderPath when calling FilePathDefinition., must conform to the pattern /^.*$/.");
        }
