 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class S3StorageCredentials implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'S3Storage_credentials';
    ...
    protected static $swaggerTypes = [
        'aws_secret_key' => '\BytescalePHP\Client\Model\AwsSecretKey',
        'aws_access_key' => '\BytescalePHP\Client\Model\AwsAccessKey'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['aws_secret_key'] === null) {
            $invalidProperties[] = "'aws_secret_key' can't be null";
        }
        if ($this->container['aws_access_key'] === null) {
            $invalidProperties[] = "'aws_access_key' can't be null";
        }
     ...
     * Sets aws_secret_key
     *
     * @param \BytescalePHP\Client\Model\AwsSecretKey $aws_secret_key aws_secret_key
     *
     * @return $this
     */
     ...
     * Sets aws_access_key
     *
     * @param \BytescalePHP\Client\Model\AwsAccessKey $aws_access_key aws_access_key
     *
     * @return $this
     */
