 ...
 */
class UploadFromUrlRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UploadFromUrlRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^https?:\/\/[-a-zA-Z0-9]+(?:\\.[-a-zA-Z0-9]+)+(\/.*)?$/", $this->container['url'])) {
            $invalidProperties[] = "invalid value for 'url', must be conform to the pattern /^https?:\/\/[-a-zA-Z0-9]+(?:\\.[-a-zA-Z0-9]+)+(\/.*)?$/.";
        }
    ...
    public function setMime($mime)
    {
        ...
        if ((mb_strlen($mime) > 255)) {
            throw new \InvalidArgumentException('invalid length for $mime when calling UploadFromUrlRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($mime) < 3)) {
            throw new \InvalidArgumentException('invalid length for $mime when calling UploadFromUrlRequest., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+\/[a-zA-Z0-9+\\-._]+(?:;[^=]+=[^;]+)*$/", ObjectSerializer::toString($mime)))) {
            throw new \InvalidArgumentException("invalid value for \$mime when calling UploadFromUrlRequest., must conform to the pattern /^[a-zA-Z0-9]+\/[a-zA-Z0-9+\\-._]+(?:;[^=]+=[^;]+)*$/.");
        }
    ...
    public function setOriginalFileName($originalFileName)
    {
        ...
        if ((mb_strlen($originalFileName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $originalFileName when calling UploadFromUrlRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($originalFileName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $originalFileName when calling UploadFromUrlRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^.+$/", ObjectSerializer::toString($originalFileName)))) {
            throw new \InvalidArgumentException("invalid value for \$originalFileName when calling UploadFromUrlRequest., must conform to the pattern /^.+$/.");
        }
     ...
     * Sets url
     *
     * @param string $url Source URL to upload.
     *
     * @return self
     */
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $url when calling UploadFromUrlRequest., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling UploadFromUrlRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^https?:\/\/[-a-zA-Z0-9]+(?:\\.[-a-zA-Z0-9]+)+(\/.*)?$/", ObjectSerializer::toString($url)))) {
            throw new \InvalidArgumentException("invalid value for \$url when calling UploadFromUrlRequest., must conform to the pattern /^https?:\/\/[-a-zA-Z0-9]+(?:\\.[-a-zA-Z0-9]+)+(\/.*)?$/.");
        }
