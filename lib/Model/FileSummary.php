 ...
 */
class FileSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FileSummary';
    ...
    */
    ...
    public function setFilePath($filePath)
    {
        ...
        if ((mb_strlen($filePath) > 512)) {
            throw new \InvalidArgumentException('invalid length for $filePath when calling FileSummary., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($filePath) < 1)) {
            throw new \InvalidArgumentException('invalid length for $filePath when calling FileSummary., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\/.*$/", ObjectSerializer::toString($filePath)))) {
            throw new \InvalidArgumentException("invalid value for \$filePath when calling FileSummary., must conform to the pattern /^\/.*$/.");
        }
    ...
    public function setFileUrl($fileUrl)
    {
        ...
        if ((mb_strlen($fileUrl) > 255)) {
            throw new \InvalidArgumentException('invalid length for $fileUrl when calling FileSummary., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($fileUrl) < 1)) {
            throw new \InvalidArgumentException('invalid length for $fileUrl when calling FileSummary., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^https?:\/\/[-a-zA-Z0-9]+(?:\\.[-a-zA-Z0-9]+)+(\/.*)?$/", ObjectSerializer::toString($fileUrl)))) {
            throw new \InvalidArgumentException("invalid value for \$fileUrl when calling FileSummary., must conform to the pattern /^https?:\/\/[-a-zA-Z0-9]+(?:\\.[-a-zA-Z0-9]+)+(\/.*)?$/.");
        }
    ...
    public function setLastModified($lastModified)
    {
        ...
        if (($lastModified < 0)) {
            throw new \InvalidArgumentException('invalid value for $lastModified when calling FileSummary., must be bigger than or equal to 0.');
        }
    ...
    public function setSize($size)
    {
        ...
        if (($size < 0)) {
            throw new \InvalidArgumentException('invalid value for $size when calling FileSummary., must be bigger than or equal to 0.');
        }
