...
/**
 * UnspecifiedFieldValue Class Doc Comment
 *
 * @category Class
 ...
 */
class UnspecifiedFieldValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnspecifiedFieldValue';
    ...
    */
     ...
     * Sets set
     *
     * @param bool $set This field is always `false`. Indicates the property *will not* be updated as part of the request.
     *
     * @return self
     */
