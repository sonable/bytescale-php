...
> \Swagger\Client\Model\BeginMultipartUploadResponse beginMultipartUpload($body, $account_id)
...
$body = new \Swagger\Client\Model\BeginMultipartUploadRequest(); // \Swagger\Client\Model\BeginMultipartUploadRequest | File upload parameters.
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\BeginMultipartUploadRequest**](../Model/BeginMultipartUploadRequest.md)| File upload parameters. |
 **account_id** | [**\Swagger\Client\Model\AccountId**](../Model/.md)|  |

### Return type

[**\Swagger\Client\Model\BeginMultipartUploadResponse**](../Model/BeginMultipartUploadResponse.md)
...
$body = new \Swagger\Client\Model\CompleteUploadPartRequest(); // \Swagger\Client\Model\CompleteUploadPartRequest | 
$account_id = new \Swagger\Client\Model\AccountId(); // \Swagger\Client\Model\AccountId | 
$upload_id = new \Swagger\Client\Model\UploadId(); // \Swagger\Client\Model\UploadId | 
$upload_part_index = new \Swagger\Client\Model\UploadPartIndex(); // \Swagger\Client\Model\UploadPartIndex | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\CompleteUploadPartRequest**](../Model/CompleteUploadPartRequest.md)|  |
 **account_id** | [**\Swagger\Client\Model\AccountId**](../Model/.md)|  |
 **upload_id** | [**\Swagger\Client\Model\UploadId**](../Model/.md)|  |
 **upload_part_index** | [**\Swagger\Client\Model\UploadPartIndex**](../Model/.md)|  |
...
# **getUploadPart**
> \Swagger\Client\Model\UploadPart getUploadPart($account_id, $upload_id, $upload_part_index)
...
[**\Swagger\Client\Model\UploadPart**](../Model/UploadPart.md)
...
# **listUploadParts**
> \Swagger\Client\Model\UploadPartList listUploadParts($account_id, $upload_id)
...
[**\Swagger\Client\Model\UploadPartList**](../Model/UploadPartList.md)
...
# **uploadFromUrl**
> \Swagger\Client\Model\BasicUploadResponse uploadFromUrl($body, $account_id)
...
$body = new \Swagger\Client\Model\UploadFromUrlRequest(); // \Swagger\Client\Model\UploadFromUrlRequest | File upload parameters.
$account_id = new \Swagger\Client\Model\AccountId(); // \Swagger\Client\Model\AccountId | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\UploadFromUrlRequest**](../Model/UploadFromUrlRequest.md)| File upload parameters. |
 **account_id** | [**\Swagger\Client\Model\AccountId**](../Model/.md)|  |

### Return type

[**\Swagger\Client\Model\BasicUploadResponse**](../Model/BasicUploadResponse.md)
