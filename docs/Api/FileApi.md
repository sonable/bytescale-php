...
# **copyFile**
> \Swagger\Client\Model\CopyFileResponse copyFile($body, $account_id)
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\CopyFileRequest**](../Model/CopyFileRequest.md)|  |
...
# **copyFileBatch**
> \Swagger\Client\Model\AsyncResponse copyFileBatch($body, $account_id)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\CopyFileBatchRequest**](../Model/CopyFileBatchRequest.md)|  |
 **account_id** | [**\Swagger\Client\Model\AccountId**](../Model/.md)|  |
...
------------- | ------------- | ------------- | -------------
 **account_id** | [**\Swagger\Client\Model\AccountId**](../Model/.md)|  |
 **file_path** | [**\Swagger\Client\Model\FilePath**](../Model/.md)|  |
...
# **deleteFileBatch**
> \Swagger\Client\Model\AsyncResponse deleteFileBatch($body, $account_id)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\DeleteFileBatchRequest**](../Model/DeleteFileBatchRequest.md)|  |
 **account_id** | [**\Swagger\Client\Model\AccountId**](../Model/.md)|  |
...
# **getFileDetails**
> \Swagger\Client\Model\FileDetails getFileDetails($account_id, $file_path)
...
[**\Swagger\Client\Model\FileDetails**](../Model/FileDetails.md)
 ...
 **account_id** | [**\Swagger\Client\Model\AccountId**](../Model/.md)|  |
 **file_path** | [**\Swagger\Client\Model\FilePath**](../Model/.md)|  |
 **transformation** | [**\Swagger\Client\Model\TransformationUrlSlug**](../Model/.md)| The name of the File Processing API (e.g. &#x60;image&#x60;, &#x60;video&#x60;, &#x60;audio&#x60;) or transformation preset (created in the Bytescale Dashboard) to use when processing the file. |
 **artifact** | [**\Swagger\Client\Model\TransformationArtifactPath**](../Model/.md)| Some transformations output multiple files, called artifacts.  You can download each individual transformation artifact by specifying its path with this parameter | [optional]
...
# **processFileAndSave**
> \Swagger\Client\Model\ProcessFileAndSaveResponse processFileAndSave($body, $account_id, $file_path, $transformation, $transformation_params)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\ProcessFileAndSaveRequest**](../Model/ProcessFileAndSaveRequest.md)| File output parameters. |
 **account_id** | [**\Swagger\Client\Model\AccountId**](../Model/.md)|  |
 **file_path** | [**\Swagger\Client\Model\FilePath**](../Model/.md)|  |
 **transformation** | [**\Swagger\Client\Model\TransformationUrlSlug**](../Model/.md)| The name of the File Processing API (e.g. &#x60;image&#x60;, &#x60;video&#x60;, &#x60;audio&#x60;) or transformation preset (created in the Bytescale Dashboard) to use when processing the file. |
 **transformation_params** | [**\Swagger\Client\Model\TransformationParams**](../Model/.md)| Parameters to submit to the File Processing API (e.g. the Image Processing API).  Please see the documentation for each File Processing API to determine which values can appear here:  - https://www.bytescale.com/docs/image-processing-api - https://www.bytescale.com/docs/video-processing-api - https://www.bytescale.com/docs/audio-processing-api - https://www.bytescale.com/docs/archive-processing-api | [optional]
...
[**\Swagger\Client\Model\ProcessFileAndSaveResponse**](../Model/ProcessFileAndSaveResponse.md)
